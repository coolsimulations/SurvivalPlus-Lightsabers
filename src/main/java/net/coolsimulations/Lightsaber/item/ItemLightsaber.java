...
public class ItemLightsaber extends Item{
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack)
    {
    	if(stack.getItem() == LightsaberItems.darksaber){
    		entityLiving.worldObj.playSound((EntityPlayer) entityLiving, entityLiving.getPosition(), LightsaberSoundHandler.darksaber_swing, SoundCategory.HOSTILE, 1.0F, 1.0F);
    	} else {
    		entityLiving.worldObj.playSound((EntityPlayer) entityLiving, entityLiving.getPosition(), LightsaberSoundHandler.lightsaber_swing, SoundCategory.HOSTILE, 1.0F, 1.0F);
    	}
        return false;
    }
